...
export class AppComponent implements OnInit {
  ...
  private formElements = [
    ...
    { id: 7, label: 'Input Date Time', link: '/components/form/input-date-time' },
    { id: 8, label: 'Input Timepicker', link: '/components/form/input-timepicker' },
    { id: 9, label: 'Input Select', link: '/components/form/input-select' },
    { id: 10, label: 'Input File', link: '/components/form/input-file' },
    { id: 11, label: 'Input File Image', link: '/components/form/input-file-image' },
    { id: 12, label: 'Input Opt', link: '/components/form/input-opt' },
    { id: 13, label: 'Input Password', link: '/components/form/input-password' },
    { id: 14, label: 'Editor', link: '/components/form/editor' },
    { id: 15, label: 'Document Editor', link: '/components/form/document-editor' },
    { id: 16, label: 'Checkbox', link: '/components/form/checkbox' },
    { id: 17, label: 'Checkbox Group', link: '/components/form/checkbox-group' },
    { id: 18, label: 'Radio', link: '/components/form/radio' },
    { id: 19, label: 'Radio Group', link: '/components/form/radio-group' },
    { id: 20, label: 'Rating', link: '/components/form/rating' },
    { id: 21, label: 'Switch', link: '/components/form/switch' },
  ];

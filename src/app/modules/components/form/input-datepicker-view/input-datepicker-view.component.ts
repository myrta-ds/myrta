...
@Component({
  selector: 'mrx-input-datepicker-view',
  templateUrl: './input-datepicker-view.component.html',
  styleUrls: ['./input-datepicker-view.component.less']
})
export class InputDatepickerViewComponent {

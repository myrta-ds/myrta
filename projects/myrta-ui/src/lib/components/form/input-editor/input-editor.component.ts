import {
  ...
  OnDestroy,
  OnInit,
  Output, Renderer2, SecurityContext, TemplateRef,
  ViewChild
} from '@angular/core';
...
export class InputEditorComponent implements OnInit, ControlValueAccessor, AfterViewInit, OnDestroy {
